...
public:
  ...
  kwiver::vital::image_container_sptr image() const;

  QPointF viewSpaceToWorldSpace(QPointF const& viewCoord) const;
...
signals:
  ...
  void homographyChanged(QMatrix4x4 const& homography) const;
